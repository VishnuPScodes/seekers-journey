...
import { Home, BookOpen, Settings, LineChart, Menu, X, Sun, LogOut, Mountain, Clock } from 'lucide-react';
...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { path: '/personal-journey', label: 'Personal Journey', icon: <Clock size={18} strokeWidth={1.5} />, id: 'nav-personal-journey' },
